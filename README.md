# Переделываем уличный инфракрасный датчик движения в умный датчик присутствия
...
Конфиг: [presence-sensor-street-1.yaml](https://github.com/diemon24/Presence-relay/blob/main/presence-sensor-street-1.yaml)
